...
<body>
  <div class="btn-group">
    ...
    <div class="dropdown-menu">
      ...
      <a class="dropdown-item" href="../lancheManha/index.php"> LAHCHE MANHÃ</a>
      <a class="dropdown-item" href="../lancheTarde/index.php">LANCHE TARDE</a>
    </div>
  </div>
  <div class="geral">
    ...
    <form action="buscar_aluno.php" method="GET" class="form-group ">
      ...
      <button type="submit" class="btn btn-success">CONFIRMAR ALMOÇO</button>
    </form>
  </div>
  <!-- Optional JavaScript -->
