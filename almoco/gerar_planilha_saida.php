...
<head>
  <title>GERAR PLANILHA SAIDA</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body>
  ...
  $arquivo = 'planilha_saida.xls';
  // Criamos uma tabela HTML com o formato da planilha
  $html = '';
  $html .= '<table border="1">';
  $html .= '<tr>';
  $html .= '<td colspan="6"> PLANILHA SAÍDAS DOS ALUNOS</tr>';
  $html .= '</tr>';
  ...
  $html .= '<td><b>data_saida</b></td>';
  $html .= '</tr>';

  //Selecionar todos os itens da tabela 
  $result_msg_contatos = "SELECT * FROM tb_registro_saida";
  ...
  while ($row_msg_contatos = mysqli_fetch_assoc($resultado_msg_contatos)) {
    ...
    $html .= '<td>' . $row_msg_contatos["data_saida"] . '</td>';
